    ...
    for sf in split_folders:
        ...
        if split in ['train', 'val', 'test']:
            ...
            if len(lbl_list)>len(img_list):
                ...
                np.savetxt(os.path.join(base_dir, f'{split}_msk_without_img.csv'), arr_lbl_woimg)
                ...
                np.savetxt(os.path.join(base_dir, f'{split}_img_without_msk.csv'), arr_img_wolbl)
